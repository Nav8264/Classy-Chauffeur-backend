...
<tr>
  ...
  <table style="width:100%;">
      ...
      <tr>
          <td>${customerName}<br> Mb: ${customerPhoneNo}</td>
  ...
  <table class="test" style="margin: auto; width: 40%; position: relative; top: -245px; left: 207px; text-align: center;">
    ...
    <tr>
      <td style=" border:2px solid black; width: 100px;"> Flat Rate &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  ${flatRate} <br><b>Reservation Total (AUD):</b> &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ${reservationTotal} <br><b>Payments/Deposits (AUD):</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ${paymentsDeposits} <br><b>Total Outstanding (AUD): </b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   ${totalDue}</td>
    </tr>
  </table>
  </body>
  </html>
...
module.exports = CustomerTripSheet;
